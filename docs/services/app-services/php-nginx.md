...
![Create php-nginx service - general settings](../../img/new_interface/creating_service_php_nginx_general_settings.png)
...
![Create php-nginx service - network settings](../../img/new_interface/creating_service_php_network_settings.png)
...
![Create php-nginx service - application settings](../../img/new_interface/creating_service_php_apache_application_settings.png)
...
![Create service - configs](../../img/new_interface/creating_service_php_apache_configs.png)
...
![Create service - create configs](../../img/new_interface/creating_service_php_apache_configs_create.png)

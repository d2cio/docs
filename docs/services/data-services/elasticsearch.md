...
![Create elasticsearch service - general settings](../../img/new_interface/creating_service_elasticsearch_general_settings.png)
...
![Create elasticsearch service - network settings](../../img/new_interface/creating_service_elasticsearch_network_settings.png)
...
![Create elasticsearch service - extra settings](../../img/new_interface/creating_service_db_extra_settings.png)
...
![Create elasticsearch service - environment variables](../../img/new_interface/creating_service_elasticsearch_env.png)

You can specify environment variables for your application. They can be edited after creating a service.

## Persistent data volumes

![Create service - persistent data volumes](../../img/new_interface/creating_service_elasticsearch_volumes.png)
...
![Create service - configs](../../img/new_interface/creating_service_elasticsearch_configs.png)
